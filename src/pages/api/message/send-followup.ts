...
import { followUpEmailWriter } from "@/utils/mail/followUpEmailWriter";
...
export default async function handler(
  ...
  try {
    ...
    const template = await followUpEmailWriter(jobDescription);
    ...
    console.log("-- Follow up sending results:", results);
